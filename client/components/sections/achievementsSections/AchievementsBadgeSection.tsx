...
const AchievementsBadgeSection = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={{fontSize: 31, fontWeight: 'bold'}}>Bronze badge</Text>
            <Text style={{fontSize: 31}}>346 points</Text>
            <Text style={{fontSize: 18, paddingTop: 15}}>54 points away from the Silver badge!</Text>
        </View>
    )
}
